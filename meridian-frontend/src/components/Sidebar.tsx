...
export function Sidebar() {
  ...
  return (
    <>
      <aside
        className={`fixed inset-y-0 left-0 z-30 flex w-[260px] shrink-0 flex-col overflow-y-auto px-4 py-6 transition-transform lg:sticky lg:top-0 lg:h-full lg:translate-x-0 ${
