    ...
    <div className="min-h-screen pb-20">
      {loading ? (
        <div className="space-y-4 p-6">
          ...
          <Skeleton height="1rem" width="90%" rounded="md" />
          <Skeleton height="200px" width="100%" rounded="lg" className="mt-4" />
          <Skeleton height="1rem" width="50%" rounded="sm" className="mt-4" />
        </div>
      ) : (
        <>
