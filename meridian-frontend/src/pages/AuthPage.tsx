...
export function AuthPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // mock auth — wire to real API later
    navigate('/feed');
  };
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="flex h-11 w-full items-center justify-center gap-2 rounded-xl text-sm font-bold transition-all hover:brightness-110"
